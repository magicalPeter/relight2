...
function startProcessing() {
    ...
    document.getElementById('loader-overlay-div').setAttribute('style', 'display: none; visibility: hidden;')
    lightPosSpan.innerHTML = '[' + lightDir[0].toFixed(2) + ', ' + lightDir[1].toFixed(2) + ', ' + lightDir[2].toFixed(2) + ']';
    lightIntensitySpan.innerHTML = lightIntensity;
    draw();
...
function sliderUpdate() {
    lightDir = [xlightSlider.value / 100, ylightSlider.value / 100, zlightSlider.value / 100];
    lightPosSpan.innerHTML = '[' + lightDir[0].toFixed(2) + ', ' + lightDir[1].toFixed(2) + ', ' + lightDir[2].toFixed(2) + ']';
...
function setupShaderAttributes() {
    ...
    gl.uniform3fv(gl.getUniformLocation(shaderProgram, 'lightDir'), lightDir);
    gl.uniform1f(gl.getUniformLocation(shaderProgram, 'lightIntensity'), lightIntensity);
    gl.uniform1i(gl.getUniformLocation(shaderProgram, 'textureLighting'), textureLighting);
